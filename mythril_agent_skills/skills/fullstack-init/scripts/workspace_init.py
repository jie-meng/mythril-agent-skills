...
- **Knowledge Graph (graphify)**: Some repos may have a `graphify-out/`
  ...
  - **Query first** — Before reading source files directly, use
    `graphify query "<question>"` to retrieve information from the
    knowledge graph.
  - **Update after changes** — After modifying files in the repo, run
    `graphify update` to keep the graph in sync.
