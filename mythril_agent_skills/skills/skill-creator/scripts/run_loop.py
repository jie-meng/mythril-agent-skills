...
def get_skill_cache_dir(skill_name: str) -> Path:
    """Return per-user cache directory for a skill."""
    ...
    return base / "mythril-skills-cache" / skill_name
...
def main():
    ...
    if args.report != "none":
        if args.report == "auto":
            ...
            cache_dir = get_skill_cache_dir("skill-creator")
